...
const covid19ImpactEstimator = (data) => {
  ...
  impact.casesForVentilatorsByRequestedTiime = impact.infectionsByRequestedTime * 0.02;
  severeImpact.casesForVentilatorsByRequestedTiime = infectionsByRequestedTime * 0.02;
